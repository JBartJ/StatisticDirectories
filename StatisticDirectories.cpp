...
void display_and_count(string path, int *f_amount, int *l_amount, int *el_amount, int *nel_amount, int *w_amount, int *lt_amount)
{
	int files_amount = 0;
	int lines_amount = 0;
	...
	cout << "The amount of words is: " << words_amount << endl;
	cout << "The amount of letters is:" << letters_amount << endl;
...
int main()
{
	...
	{
		display_and_count(path, &f_amount, &l_amount, &el_amount, &nel_amount, &w_amount, &lt_amount);
	}
